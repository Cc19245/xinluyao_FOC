...
mc_pid_t iq_pid = {
	...
	.w_upper_integral_limit = 20000,
	.w_lower_integral_limit = -20000,
	
	.h_upper_output_limit = 25000,
	.h_lower_output_limit = -25000,
};
...
mc_pid_t speed_pid = {
	...
	.w_upper_integral_limit = 1600,
	.w_lower_integral_limit = -1600,
	
	.h_upper_output_limit = 1600,
	.h_lower_output_limit = -1600,
};
...
static void mc_1ms_loop(void)
{
	...
	if (mc_flag.ctrl_loop_mode == MC_SPD_CLOSE_LOOP_MODE || mc_flag.ctrl_loop_mode == MC_POS_CLOSE_LOOP_MODE) {
		...
		qd_t i_qd;
		i_qd.q = mc_pi_controller(&speed_pid, w_err);
		i_qd.d = 0; 
